...
*/
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('uacc_email', 'uacc_username', 'upro_first_name', 'upro_last_name');
	...
	*/
	$config['security']['login_session_expire'] = 60*60;
	...
	*/
	$config['email']['email_template_directory'] = 'layouts/email/';
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</div>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>';
