...
class Admin_model extends CI_Model {
    ...
    ###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###	
    // Generic stuff that member also can do. But this is seperated from other users.
    ###++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++###
    ...
    /**
     * get_user_accounts
     * Gets a paginated list of users that can be filtered via the user search form, filtering by the users username and first and last names.
     */
    ...
    function getDbSize() {
        ...
        $sql = "SELECT table_schema AS db_name, sum( data_length + index_length ) / 1024 AS db_size_kb 
    ...
    /**
     * Get the database Overhead
     */
    function getDbOverhead() {
        ...
        $sql = "SELECT SUM(DATA_FREE) AS db_overhead 
                FROM information_schema.TABLES 
                WHERE table_schema = $dbName;";
     ...
     * Get the database Overhead
     */
    function getDbLastOptimized() {

        $query = $this->db->select('modified_date')->from('optimized')->get();
    ...
    function optimized_dbase() {
        ...
        $this->db->where('id', '1');
        $this->db->update('optimized', $data);

        if ($result !== FALSE) {
            redirect('/backup/optimize_db');
        }
    }
