...
class Auth_model extends CI_Model {
    ...
    function resend_activation_token() {
        ...
        $this->form_validation->set_rules('activation_token_identity', 'Username', 'required');
    ...
    function forgotten_password() {
        ...
        $this->form_validation->set_rules('forgot_password_identity', 'Username', 'required');
    ...
    function update_account() {
        ...
        if ($this->form_validation->run()) {
            ...
            // Redirect user.
            ($response) ? redirect('member/dashboard') : redirect('member/update_account');
        } else {
            // Set validation errors.
            $this->data['message'] = validation_errors('<p class="error_msg">', '</p>');
    ...
    function change_password() {
        ...
        if ($this->form_validation->run()) {
            ...
            ($response) ? redirect('member/dashboard') : redirect('member/change_password');
        } else {
            // Set validation errors.
            $this->data['message'] = validation_errors('<p class="error_msg">', '</p>');
