...
class Admin extends CI_Controller {
    ...
    /**
     * Many of the functions within this controller load a custom model called 'admin_model' that has been created for the purposes of this demo.
     * The 'admin_model' file is not part of the flexi auth library, it is included to demonstrate how some of the functions of flexi auth can be used.
     *
     * These demos show working examples of how to implement some (most) of the functions available from the flexi auth library.
     * This particular controller 'admin', is used by logged in admins to manage users and user groups.
     * 
    ...
    function dashboard() {
        ...
        $this->layouts->viewAdmin('admin/dashboard_view', $this->data);
    }
    
    /**
     * update_account
     * Update account credential for admin
     */
    function update_account() {
        ...
        $this->layouts->viewAdmin('admin/account_update_view', $this->data);
    }
    ...
    function change_password() {
        ...
        $this->layouts->viewAdmin('admin/password_update_view', $this->data);
    }
    ...
    function manage_user_accounts() {
        ...
        // Set the page title
        $this->layouts->set_title('Manage User Account');
        ...
        $this->layouts->viewAdmin('admin/user_acccounts_view', $this->data);
    }
    ...
    function update_user_account($user_id) {
        ...
        // Set the page title
        $this->layouts->set_title('Update Account');
        ...
        $this->layouts->viewAdmin('admin/user_account_update_view', $this->data);
    }
    ...
    function manage_user_groups() {
        ...
        // Set the page title
        $this->layouts->set_title('Manage User Groups');
        
        // Include any css that needed. This is chained method, so just add all file like below
        $this->layouts->add_css('assets/css/bootstrap.css')
                      ->add_css('assets/css/plugins/metisMenu/metisMenu.min.css')
                      ->add_css('assets/css/plugins/social-buttons.css')
                      ->add_css('assets/css/sb-admin-2.css')
                      ->add_css('assets/font-awesome/css/font-awesome.min.css');
        ...
        $this->layouts->viewAdmin('admin/user_groups_view', $this->data);
    }
    ...
    function insert_user_group() {
        ...
        // Set the page title
        $this->layouts->set_title('Insert User Groups');
        ...
        $this->layouts->viewAdmin('admin/user_group_insert_view', $this->data);
    }
    ...
    function update_user_group($group_id) {
        ...
        // Set the page title
        $this->layouts->set_title('Update User Group');
        ...
        $this->layouts->viewAdmin('admin/user_group_update_view', $this->data);
    }
    ...
    function manage_privileges() {
        ...
        // Set the page title
        $this->layouts->set_title('Manage Privileges');
        ...
        $this->layouts->viewAdmin('admin/privileges_view', $this->data);
    }
    ...
    function insert_privilege() {
        ...
        // Set the page title
        $this->layouts->set_title('Insert New Privileges');
        ...
        $this->layouts->viewAdmin('admin/privilege_insert_view', $this->data);
    }
    ...
    function update_privilege($privilege_id) {
        ...
        // Set the page title
        $this->layouts->set_title('Update Privileges');
        ...
        $this->layouts->viewAdmin('admin/privilege_update_view', $this->data);
    }
    ...
    function update_user_privileges($user_id) {
        ...
        // Set the page title
        $this->layouts->set_title('Update User Privileges');
        ...
        $this->layouts->viewAdmin('admin/user_privileges_update_view', $this->data);
    }
    ...
    function update_group_privileges($group_id) {
        ...
        // Set the page title
        $this->layouts->set_title('Update Group Privileges');
        ...
        $this->layouts->viewAdmin('admin/user_group_privileges_update_view', $this->data);
    }
    ...
    function list_user_status($status = FALSE) {
        ...
        // Set the page title
        $this->layouts->set_title($this->data['page_title']);
        ...
        $this->layouts->viewAdmin('admin/users_view', $this->data);
    }
    ...
    function delete_unactivated_users() {
        ...
        // Set the page title
        $this->layouts->set_title('Unactivated User List');
        ...
        $this->layouts->viewAdmin('admin/users_unactivated_view', $this->data);
    }
